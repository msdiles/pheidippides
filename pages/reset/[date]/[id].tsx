...
import {mustHaveDigit, mustHaveLowercase, mustHaveOnlyLettersAndDigits, mustHaveUppercase} from "@/utils/validators"
...
const Login = () => {
  const {onSubmit, errors, register, watch, loading: resetLoading, isChanged} = useResetPasswordPage()
  ...
  return <EmptyLayout>
    ...
    <Paper elevation={3} className="auth-form-box">
      ...
      <form className="auth-form" onSubmit={onSubmit}>
        ...
        >Reset password
          {resetLoading && <CircularProgress size={24} className={styles.buttonProgress}/>}
        </Button>
      </form>
    ...
    <Dialog
      ...
      <DialogActions>
        ...
        <Button onClick={() => Router.push("/reset/link")} color="primary" autoFocus>
          Reset password
        </Button>
      </DialogActions>
    </Dialog>
